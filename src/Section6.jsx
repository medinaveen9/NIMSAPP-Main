...
//     e.preventDefault();
//     setShowPreview(true); // go to preview mode
//   };
...
//           <li>Participant Info - Version: {version1}, Date: {date1}</li>
//           <li>ICF - Version: {version2}, Date: {date2}</li>
//           <li>English Consent - Version: {version3}, Date: {date3}</li>
...
//         <button className="custom-button" onClick={handleSubmit}>Confirm Submit</button>
//       </div>
//     );
//   }
...
//         <div className="h">
//           <div className="m">(b)Documents</div>
